 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://jaxb.ws.jax.samples.chathurangaonline.com/", wsdlLocation = "http://localhost:8080/employee-service/empServiceUrl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://jaxb.ws.jax.samples.chathurangaonline.com/", "EmployeeServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/employee-service/empServiceUrl?wsdl");
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://jaxb.ws.jax.samples.chathurangaonline.com/", "EmployeeServiceImplPort"), EmployeeServiceImpl.class);
    }
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxb.ws.jax.samples.chathurangaonline.com/", "EmployeeServiceImplPort"), EmployeeServiceImpl.class, features);
    }
